<h1>ຍິນດີຕອນຮັບສູ່ <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row">
          <div class="col-12 col-sm-4 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">ລາຍການຫມວດສິນຄ້າທັງຫມົດ</span>
          ...
          <div class="col-12 col-sm-4 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">ລານການສິນຄ້າທັງຫມົດ</span>
                <span class="info-box-number text-right">
                  <?php 
          ...
          <div class="col-12 col-sm-4 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">ຍອດຂາຍທັງຫມົດ</span>
                <span class="info-box-number text-right">
                  <?php 
