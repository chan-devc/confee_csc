                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="client_id" class="form-control form-control-sm" required>
                                        ...
                                        <option value="1" <?= $client_id == 1 ? 'selected' : '' ?>>ລູກຄ້າທົ່ວໄປ</option>

                                        <option value="2" <?= $client_id == 2 ? 'selected' : '' ?>>ພະນັກງານ</option>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <button class="btn btn-primary rounded-0 btn-sm"><i class="fa fa-filter"></i>
                                        Filter</button>

                                    <button class="btn btn-light border rounded-0 btn-sm" type="button" id="print"><i
                    ...
                    <table class="table table-hover table-striped table-bordered" id="report-list">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET["client_id"]) && $_GET["client_id"] > 0) {
                                ...
                                $where .= " and c.client_type = '{$_GET["client_id"]}' ";
                            }
                            ...
                            $qry = $conn->query("SELECT 
                                ...
                                un.name AS unname, 
                                pl.price,
                                sp.price as net_price,
                                SUM(sp.qty) AS qty,
                                SUM(sp.price * sp.qty) AS amount 
                            ...
                            WHERE sl.status = 1  
                            AND DATE(sl.date_created) BETWEEN '2025-03-01' AND '2025-03-31' $where
                            GROUP BY sp.product_id, sp.price
                            order by DATE(sl.date_created) desc");
                            ...
                            while ($row = $qry->fetch_assoc()):
                                ...
                                <tr>
                                    ...
                                    <td class='text-right'>
                                        ...
                                        <p class="m-0"><?= format_num($row['qty']) ?></p>
                                    ...
                                    <td class='text-right'><?= format_num($row["net_price"]) ?></td>
