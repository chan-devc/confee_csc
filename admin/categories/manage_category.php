...
<div class="container-fluid">
	<form action="" id="category-form">
		...
		<div class="form-group">
			<label for="category_type" class="control-label">ປະເພດ</label>
			<select name="category_type" id="category_type" class="form-control form-control-sm rounded-0" required>
				<option value="1" <?php echo isset($category_type) && $category_type == 1 ? 'selected' : '' ?>>ເຄື່ອງດື່ມກາເຟ</option>
				<option value="2" <?php echo isset($category_type) && $category_type == 2 ? 'selected' : '' ?>>ສ່ວນປະກອບກາເຟຫລືເຄື່ອງໃຊ້ຕ່າງໆ</option>
			</select>
		</div>

		<div class="form-group">
			<label for="name" class="control-label">ຊື່ຫມວດ</label>
